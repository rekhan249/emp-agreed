...
class CreateContollerProvider with ChangeNotifier {
  Future<void> submittedAgreement(
    ...
    String url = ApiservicesContants.baseUrl + ApiservicesContants.createEmpApi;
    ...
    try {
      ...
      if (response.toString().isNotEmpty) {
        ...
        Fluttertoast.showToast(msg: "Emp Agreement Created Successfully");
